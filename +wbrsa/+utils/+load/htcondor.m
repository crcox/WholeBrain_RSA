function [Params, Results] = htcondor(ResultDir, varargin)
% utils.load.HTCONDOR Load results from a collection of HTCondor jobs.
%   [params] = htcondor(ResultDir); avoids loading any data.
%   [params, results] = htcondor(ResultDir);
%   [params, results] = htcondor(ResultDir, varargin);
%
%   OPTIONS:
