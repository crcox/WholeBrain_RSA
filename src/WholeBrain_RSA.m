            ...
            case 'GROWL2'
                if isempty(HYPERBAND)
                    ...
                    AdlasInstances = AdlasContainer(    ...
                        subjix,                         ... subject
                        1:size(PERMUTATION_INDEX{1},2), ... RandomSeed
                        cvholdout,                      ... cvholdout
                        BIAS, ...
                        LambdaSeq, ...
                        normalize, ...
...
function ac = AdlasContainer(subject,RandomSeed,cvholdout,finalholdout,configID)
    [i,j,k,m,n] = ndgrid(subject,RandomSeed,cvholdout,finalholdout,configID);
    ac = struct(...
        'subject'     , num2cell(i(:)), ...
        'RandomSeed'  , num2cell(j(:)), ...
        'cvholdout'   , num2cell(k(:)), ...
        'finalholdout', num2cell(m(:)), ...
        'configID'    , num2cell(n(:)), ...
        'Adlas'       , []);
end
